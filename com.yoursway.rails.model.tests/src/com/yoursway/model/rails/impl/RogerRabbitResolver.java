...
public class RogerRabbitResolver implements IResolver {
    ...
    private IModelRootProvider modelRootProvider;
    private DependencyRequestor dependencyRequestor;
    
    public RogerRabbitResolver(IModelRootProvider modelRootProvider, DependencyRequestor dependencyRequestor) {
