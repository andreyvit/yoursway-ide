...
public abstract class OverflowingLRUCache extends LRUCache {
     ...
     */
    public java.util.Hashtable<Object, LRUCacheEntry> getEntryTable() {
        return fEntryTable;
    }
    ...
    public void printStats() {
        ...
        Enumeration<Object> keys = fEntryTable.keys();
        class Temp {
        ...
        if (VERBOSE) {
            for (Iterator<Class<? extends Object>> iter = h.keySet().iterator(); iter.hasNext();) {
    ...
    public void setLoadFactor(double newLoadFactor) throws IllegalArgumentException {
        if (newLoadFactor <= 1.0 && newLoadFactor > 0.0)
            ...
            throw new IllegalArgumentException("Invalid cache load factor");
    }
