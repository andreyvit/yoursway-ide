...
public class ChooseWorkspaceDialog extends TitleAreaDialog {
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        setMessage(NLS.bind("{0} stores your projects in a folder called a workspace.\n" + 
"Choose a workspace folder to use for this session.", productName));
    ...
    private void createShowDialogButton(Composite parent) {
        ...
        button.setText("&Use this as the default and do not ask again");
