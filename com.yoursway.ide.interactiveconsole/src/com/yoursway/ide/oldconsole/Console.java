...
public class Console {
    ...
    public Console(final IUserSettings settings) {
        ...
        executor.addTerminationListener(new TerminationListener() {
        ...
        executor.addOutputListener(new OutputListener() {
    ...
    public List<WorksheetCompletionProposal> getWorksheetCompletionProposals() {
        int position = styledText.getSelection().x - inputOffset();
        if (position < 0)
            return null;
        return executor.complete(command(), position);
    }
    ...
    public void useWorksheetCompletionProposal(final WorksheetCompletionProposal proposal, boolean select) {
