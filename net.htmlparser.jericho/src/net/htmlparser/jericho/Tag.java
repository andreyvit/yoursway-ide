 ...
 *    {@linkplain Source#getNextStartTag(int pos, String attributeName, String value, boolean valueCaseSensitive) attribute values}.
 *    <ul class="Unseparated">
...
public abstract class Tag extends Segment {
	...
	public Tag getNextTag() {
		if (nextTag==NOT_CACHED) nextTag=getNextTag(source,begin+1);
		return nextTag;
	}
