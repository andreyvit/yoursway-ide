...
public final class Renderer implements CharStreamSource {
	...
	public void appendTo(final Appendable appendable) throws IOException {
		new Processor(rootSegment,getMaxLineLength(),getNewLine(),getIncludeHyperlinkURLs(),getDecorateFontStyles(),getConvertNonBreakingSpaces(),getBlockIndentSize(),getListIndentSize(),getListBullets(),getTableCellSeparator()).appendTo(appendable);
	}
	...
	private static final class Processor {
		...
		public void appendTo(final Appendable appendable) throws IOException {
			...
			appendSegmentProcessingChildElements(rootSegment);
		}
		...
		private void appendSegmentProcessingChildElements(final Segment segment) throws IOException {
			appendSegmentProcessingChildElements(segment.begin,segment.end,segment.getChildElements());
		}
