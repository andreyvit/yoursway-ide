...
public class Source extends Segment implements Iterable<Segment> {
	 ...
	 * <p>
	 * Calling the {@link #getAllTags()}, {@link #getAllStartTags()}, {@link #getAllElements()} or {@link #getChildElements()} method on the <code>Source</code> object
	 ...
	 * <p>
	 * This is equivalent to {@link #getNextStartTag(int,String,String,boolean) getNextStartTag}<code>(0,"id",id,true).</code>{@link StartTag#getElement() getElement()}, assuming that the element exists.
	 * <p>
	...
	public Element getElementById(final String id) {
		final StartTag startTag=getNextStartTag(0,Attribute.ID,id,true);
	 ...
	 * {@link #getNextStartTag(int) getNextElement(pos)}.
	 * <p>
	 ...
	 */
	public void ignoreWhenParsing(final Collection<Segment> segments) {
