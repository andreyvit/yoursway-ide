...
public final class WorkbenchActionBuilder extends ActionBarAdvisor {
    ...
    private void hookListeners() {
        ...
        pageListener = new IPageListener() {
            ...
            public void pageOpened(IWorkbenchPage page) {
                ...
                IAction buildHandler = new BuildAction(page.getWorkbenchWindow().getShell(),
    ...
    protected void fillCoolBar(ICoolBarManager coolBar) {
        ...
        { // Set up the context Menu
            ...
            menuService
                    .populateContributionManager(coolbarPopupMenuManager, "popup:windowCoolbarContextMenu"); //$NON-NLS-1$
        }
     ...
     * @param infos
     *            the infos
     * @return <code>true</code> if a welcome page was found,
