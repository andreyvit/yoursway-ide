 ...
 * Never gc if there is a test harness present - Don't gc if background jobs are
 * running - Don't gc if the keyboard or mouse have been active within
...
class IDEIdleHelper {
    ...
    private Listener idleListener = null;
