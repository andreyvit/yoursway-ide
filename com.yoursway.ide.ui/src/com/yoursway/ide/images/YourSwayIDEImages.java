package com.yoursway.ide.images;
 ...
 */
public class YourSwayIDEImages {
    ...
    //    
    //    public static final ImageDescriptor DESC_OBJS_TYPEVARIABLE = createManagedFromKey(T_OBJ,
    //            IMG_OBJS_TYPEVARIABLE);
    //    
    ...
    //    public static final ImageDescriptor DESC_OBJS_NATIVE_LIB_PATH_ATTRIB = createUnManaged(T_OBJ,
    //            "native_lib_path_attrib.gif"); //$NON-NLS-1$
    //    
    ...
    //    
    //    public static final ImageDescriptor DESC_DLCL_ADD_LINKED_SOURCE_TO_BUILDPATH = createUnManaged(T_DLCL,
    //            "add_linked_source_to_buildpath.gif"); //$NON-NLS-1$
    //    public static final ImageDescriptor DESC_ELCL_ADD_LINKED_SOURCE_TO_BUILDPATH = createUnManaged(T_ELCL,
    //            "add_linked_source_to_buildpath.gif"); //$NON-NLS-1$
    //    
    ...
    //            "configure_build_path.gif"); //$NON-NLS-1$
    //    
    //    public static final ImageDescriptor DESC_DLCL_CONFIGURE_BUILDPATH_FILTERS = createUnManaged(T_DLCL,
    //            "configure_buildpath_filters.gif"); //$NON-NLS-1$
    //    public static final ImageDescriptor DESC_ELCL_CONFIGURE_BUILDPATH_FILTERS = createUnManaged(T_ELCL,
    //            "configure_buildpath_filters.gif"); //$NON-NLS-1$
    //    
    ...
    //    public static final ImageDescriptor DESC_WIZBAN_REFACTOR_FIX_DEPRECATION = createUnManaged(T_WIZBAN,
    ...
    //    public static final ImageDescriptor DESC_WIZBAN_REFACTOR_EXTRACT_SUPERTYPE = createUnManaged(T_WIZBAN,
    ...
    private static ImageDescriptor createManaged(String prefix, String name, String key) {
        ...
        if (fgImageRegistry != null) {
            Activator.log("Image registry already defined"); //$NON-NLS-1$
        }
        return result;
    }
