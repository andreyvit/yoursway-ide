...
public class RailsProjectTree implements IPresenterOwner {
    ...
    public RailsProjectTree(Composite parent, FormToolkit formToolkit, IRailsProjectTreeOwner owner) {
        this.owner = owner;
        //tree = formToolkit.createTree(parent, SWT.MULTI | SWT.VERTICAL | SWT.V_SCROLL);
        tree = new Tree(parent, SWT.MULTI | SWT.VERTICAL | SWT.V_SCROLL);
    ...
    public void setFilteringPattern(String pattern) {
