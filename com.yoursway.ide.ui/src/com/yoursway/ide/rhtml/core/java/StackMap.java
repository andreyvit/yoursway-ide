...
class StackMap {
     ...
     * @return the most recently put value to which this map maps the specified
     *         key, or <tt>null</tt> if the map contains no mapping for this
     *         key.
     */
     ...
     * map previously contained a mapping for this key, the old value is pushed
     * onto the top of this key's private stack.
     * 
     * @param key
    ...
    /**
     * Removes the most-recent mapping for this key from this StackMap if it is
     * present.
     * 
     * <p>
