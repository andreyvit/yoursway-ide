...
public class ZeroStructuredDocumentRegion implements IStructuredDocumentRegion {
    ...
    private final IStructuredDocument fParentDocument;
    ...
    public boolean sameAs(ITextRegion oldRegion, IStructuredDocumentRegion documentRegion,
    ...
    public StructuredDocumentEvent updateRegion(Object requester, IStructuredDocumentRegion flatnode,
            String changes, int start, int end) {
        throw new Error("intentionally not implemented since should never be called"); //$NON-NLS-1$
    }
}
