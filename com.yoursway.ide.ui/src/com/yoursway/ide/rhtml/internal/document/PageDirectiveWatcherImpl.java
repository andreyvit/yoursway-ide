...
class PageDirectiveWatcherImpl implements PageDirectiveWatcher {
    ...
    public PageDirectiveWatcherImpl(IDOMElement target) {
        ...
        if (contentTypeValue != null) {
            ...
            pageDirectiveAdapter.changedContentType(((IndexedRegion) targetElement).getStartOffset(),
                    contentTypeValue);
        }
        ...
        if (languageValue != null) {
            ...
            PageDirectiveAdapterImpl pageDirectiveAdapter = (PageDirectiveAdapterImpl) ((IDOMDocument) targetElement
                    .getOwnerDocument()).getAdapterFor(PageDirectiveAdapter.class);
            pageDirectiveAdapter.changedLanguage(((IndexedRegion) targetElement).getStartOffset(),
                    languageValue);
        }
            ...
            case INodeNotifier.CHANGE:
                if (changedFeature instanceof AttrImpl) {
                    ...
                    if (name.equals("contentType")) { //$NON-NLS-1$
                        ...
                        PageDirectiveAdapterImpl pageDirectiveAdapter = (PageDirectiveAdapterImpl) ((IDOMDocument) targetElement
                                .getOwnerDocument()).getAdapterFor(PageDirectiveAdapter.class);
                        pageDirectiveAdapter.changedContentType(((IndexedRegion) targetElement)
                    ...
                    if (name.equals("language")) { //$NON-NLS-1$ //$NON-NLS-2$
                        ...
                        pageDirectiveAdapter.changedLanguage(
                                ((IndexedRegion) targetElement).getStartOffset(), (String) newValue);
                    }
                }
