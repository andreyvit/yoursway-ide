...
public class PageDirectiveAdapterImpl implements PageDirectiveAdapter {
    ...
    private final List embeddedFactoryRegistry = new ArrayList();
    private String cachedLanguage;
    private String cachedContentType;
    private final INodeNotifier notifierAtCreation;
    ...
    public void setCachedContentType(String newContentType) {
        ...
        if (model == null) {
            ...
            Activator.unexpectedError("model should never be null in PageDirective Adapter");
            return;
        }
    ...
    public void setLanguage(String newLanguage) {
        ...
        IDocumentPartitioner partitioner = ((IDocumentExtension3) model.getStructuredDocument())
    ...
    private boolean languageKnown(String language) {
        return (StringUtils.contains(JAVA_LANGUAGE_KEYS, language, false) || StringUtils.contains(
                JAVASCRIPT_LANGUAGE_KEYS, language, false));
    }
