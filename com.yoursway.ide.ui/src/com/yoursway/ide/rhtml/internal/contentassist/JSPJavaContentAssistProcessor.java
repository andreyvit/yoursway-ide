...
public class JSPJavaContentAssistProcessor implements IContentAssistProcessor, IReleasable {
    ...
    protected static final String UNKNOWN_CONTEXT = "Content Assist not available at the current location";
    ...
    public ICompletionProposal[] computeCompletionProposals(ITextViewer viewer, int documentPosition) {
        ...
        ICompletionProposal[] results = fJspCompletionProcessor.computeCompletionProposals(viewer,
                documentPosition);
        ...
        if (flat != null && flat.getType() != DOMJSPRegionContexts.JSP_SCRIPTLET_OPEN
                ...
                && (openRegion != null && openRegion.getType() != DOMJSPRegionContexts.JSP_DIRECTIVE_OPEN)
    ...
    private CustomCompletionProposal createCDATAProposal(int adjustedDocPosition, int selectionLength) {
        return new CustomCompletionProposal("<![CDATA[]]>", //$NON-NLS-1$
                ...
                9, SharedXMLEditorPluginImageHelper
                        .getImage(SharedXMLEditorPluginImageHelper.IMG_OBJ_CDATASECTION), "CDATA Section", //$NON-NLS-1$
    ...
    private void initializePreferences() {
        fAutoActivate = true;
        String autoCharacters = ".";
        completionProposalAutoActivationCharacters = (autoCharacters != null) ? autoCharacters.toCharArray()
                : new char[0];
    }
}
