...
public class JSPDocumentLoader extends AbstractDocumentLoader {
    ...
    @Override
    synchronized public IEncodedDocument createNewStructuredDocument(IFile iFile) throws IOException,
            CoreException {
    ...
    private IStructuredDocument createCodedDocument(IFile iFile) throws CoreException,
    ...
    @Override
    public IEncodedDocument createNewStructuredDocument(String filename, InputStream inputStream)
        ...
        try {
            ...
            fFullPreparedReader.reset();
            if (embeddedType != null)
                embeddedType.initializeParser((JSPCapableParser) ((IStructuredDocument) structuredDocument)
                        .getParser());
            setDocumentContentsFromReader(structuredDocument, fFullPreparedReader);
     ...
     * v1.2 specification.
     */
    private EmbeddedTypeHandler getEmbeddedType(IFile file) throws UnsupportedEncodingException,
        ...
        if (fFullPreparedReader == null) {
            ...
            BufferedLimitedReader limitedReader = new BufferedLimitedReader(fullPreparedReader,
