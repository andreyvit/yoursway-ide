package com.yoursway.ide.rhtml.internal.registry;
...
public class AdapterFactoryProviderForJSP implements AdapterFactoryProvider {
    ...
    protected void addContentBasedFactories(IStructuredModel structuredModel) {
        ...
        ErbHtmlModelHandler.ensureTranslationAdapterFactory(structuredModel);
    }
    ...
    public boolean isFor(IDocumentTypeHandler contentTypeDescription) {
        return (contentTypeDescription instanceof ErbHtmlModelHandler);
    }
