                ...
                if (baseLocation != null) {
                    ...
                    if (file.exists()) {
                        ...
                        if (basePath.segmentCount() > 1)
                            ...
                            derivedPath = ResourcesPlugin.getWorkspace().getRoot().getLocation().append(
                                    basePath);
                        if (derivedPath != null) {
                    ...
                    modelQueryAdapterImpl = new JSPModelQueryAdapterImpl(new CMDocumentCache(), modelQuery,
                            resolver);
                }
            }
        }
    ...
    protected void updateResolver(IStructuredModel model) {
        ...
        if (path.segmentCount() > 1) {
            ...
            if (baseFile.isAccessible()) {
                ...
                modelQueryAdapterImpl.setIdResolver(new XMLCatalogIdResolver(baseLocation, model
                        .getResolver()));
            }
        }
    }
