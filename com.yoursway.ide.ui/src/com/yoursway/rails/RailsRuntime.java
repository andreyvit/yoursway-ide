...
public class RailsRuntime {
	...
	/**
	 * Inspects the given Rails instance and adds it to the registry of Rails instances.
	 * 
	...
	/**
	 * Searches for all Rails instances in single Ruby installation, and triggers the getting information
	 * about each installed Rails instance.
	 * 
	 * FIXME: move most of the code to the separate class.
	 * 
	 * FIXME: outer try/catch is a workaround: sometimes ruby1.9 process reports exit code 0 instead of 3.
	 */
