...
import com.yoursway.js.wala.JavaScriptLoader.JavaScriptMethodObject;
import com.yoursway.ruby.wala.classloader.RubyMethodObject;

public class RubyScopeMappingInstanceKeys extends ScopeMappingInstanceKeys {
    
    private final IClassHierarchy cha;
    private final IClass codeBody;
    
    public RubyScopeMappingInstanceKeys(IClassHierarchy cha, PropagationCallGraphBuilder builder,
            InstanceKeyFactory basic) {
        super(builder, basic);
        this.cha = cha;
        
        this.codeBody = cha.lookupClass(RubyTypes.CodeBody);
    }
    
    protected LexicalParent[] getParents(InstanceKey base) {
        RubyMethodObject function = (RubyMethodObject) base.getConcreteType().getMethod(
